...
# provisionado por 15SOAT-Fase1-database (Epic 2), via var.environment_id.
# Ver "Hierarquia e ownership" em
# 15SOAT-Fase1/docs/architecture/rfcs/rfc-002-managed-database-strategy.md.
resource "dokploy_application" "fase1" {
  name           = "15SOAT-Fase1-app"
...
resource "dokploy_domain" "fase1" {
  application_id   = dokploy_application.fase1.id
